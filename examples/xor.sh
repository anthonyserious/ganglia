...
curl -XPOST http://localhost:8182/api/networks/xor
echo
echo "Adding training data for XOR network"
curl -XPOST -H "Content-Type: application/json" -d '{"data":[{"input": [0, 0], "output": [0]}, {"input": [0, 1], "output": [1]}, {"input": [1, 0], "output": [1]}, {"input": [1, 1], "output": [0]}]}' http://localhost:8182/api/networks/xor/trainingdata
echo
echo "Training XOR network"
curl -XPOST http://localhost:8182/api/networks/xor/train
echo
